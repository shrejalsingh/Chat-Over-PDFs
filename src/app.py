...
def working_process(generation_config):
    ...
    model = genai.GenerativeModel(model_name="gemini-2.0-flash", generation_config=generation_config, system_instruction=system_instruction)
...
def main():
    ...
    genai.configure(api_key="AIzaSyC9jc0wiA_SeBtogbmuDRuqaenWZanjABY")
